...
/**
 * MusicvideosSearch represents the model behind the search form of `app\models\Musicvideos`.
 */
class MusicvideosSearch extends Musicvideos
{
    /**
     * {@inheritdoc}
     */
